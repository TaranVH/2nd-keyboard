...
// KEYMAP FOR F23 WRAPPING
// My github: https://github.com/TaranVH/2nd-keyboard
// notice how capslock, numlock, pause/break, and all the modifier keys... have been replaced with other keys.
// If you don't like that, you can make your own keymap where you keep whatever modifiers you like. They will NOT be "wrapped" in F23.
...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
     ...
     */
    [0] = LAYOUT_all(
                      KC_F13,  KC_F14,  KC_F15,  KC_F16, KC_F17, KC_F18, KC_F19,  KC_F20,  KC_F21,  KC_F22,  KC_NO,  KC_F24,
    ...
    KC_INT2,		 KC_NUBS, KC_Z,    KC_X,    KC_C,    KC_V,   KC_B,   KC_N,   KC_M,    KC_COMM, KC_DOT,  KC_SLSH,            KC_RO,   KC_INT3, 		   KC_UP,               KC_P1,   KC_P2,   KC_P3,   KC_PEQL,    KC_EXEC, KC_PSTE,
    KC_LANG2,		 KC_LANG1,	  KC_INT1,	   KC_MHEN, KC_HANJ,         KC_SPC, KC_HAEN, KC_HENK, KC_KANA, KC_LANG4, KC_LANG3, KC_INT4, KC_INT5, KC_LEFT, KC_DOWN, KC_RGHT,    KC_P0,            KC_PDOT, KC_PENT,    KC_FIND, KC_CUT
    ),
    [1] = LAYOUT_all(
