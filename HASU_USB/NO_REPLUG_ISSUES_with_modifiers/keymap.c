...
const action_t actionmaps[][UNIMAP_ROWS][UNIMAP_COLS] PROGMEM = {
    ...
    ESC,      F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12,           PSCR,SLCK,KP_COMMA,         VOLD,VOLU,MUTE,
    ...
    LCTL,LANG1,LALT,MHEN,         SPC,        HENK,KANA,RALT,LANG3,INT4,RCTL,     LEFT,DOWN,RGHT,    P0,       PDOT,PEQL
    ),
    UNIMAP(
